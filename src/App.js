    ...
    const fetchData = async () => {
      try {
        const response = await axios.post(
          `${process.env.REACT_APP_API_BASE_URL}/trip/`,
          {
            ...
            // current_location: [36.78412549571565, -2.5520393760289686],
            // pickup_location: [36.961085845627245, -1.150572927136488],
            // dropoff_location: [37.087837524562595, -1.0399388094312645],
            // current_cycle: 20,
          }
        );
